...
public class DBInterface {
    ...
    public long insereixContacte(String nom, String email){
        ...
        initualValues.put(CLAU_NOM,nom);
        initualValues.put(CLAU_EMAIL,email);
        return bd.insert(BD_TAULA,null, initualValues);
    }
    ...
    public Cursor obtenirTotsElsContactes(){
        return bd.query(BD_TAULA, new String[] {CLAU_ID,CLAU_NOM,CLAU_EMAIL},null,null,null,null,null,null);
    }
